...
TEST_CASE("test for filter") {
    ...
    // opencv types:
    // https://docs.opencv.org/3.4/d2/d10/core_2include_2opencv2_2core_2hal_2interface_8h.html
    cout << "sobel_x.depth() = " << sobel_x.depth() << endl;

    // make a simple image
    Mat img = (Mat_<double>(5, 5) << 10, 10, 10, 0, 0, 10, 10, 10, 0, 0, 10, 10,
               10, 0, 0, 10, 10, 10, 0, 0, 10, 10, 10, 0, 0);
    Mat sobel_img;
