...
//     // grayscale format, otherwise the BGR color space is used read in an
//     image
//     // passed as a command line argument (it may be either color or
//     grayscale)
...
TEST_CASE("basic usage of opencv") {
